...
export default function ServiceDetailPage() {
  ...
  if (!service) {
    // This case should ideally be caught by notFound() in useEffect, but as a safeguard:
    notFound();
    return null;
  }
            ...
            <CardContent className="p-6 grid grid-cols-1 sm:grid-cols-3 gap-6 text-center sm:text-left">
              ...
              <div className="flex flex-col items-center sm:items-start">
                <Button 
                    ...
                    onClick={() => toast({ title: "Booking Feature Coming Soon!", description: `Request to book "${service.name}" will be handled here.`})}
                >
