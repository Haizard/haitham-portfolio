  ...
  return (
    <Card className="sticky top-4">
      ...
      <CardContent className="space-y-4">
          ...
          availability.available && availability.pricing ? (
            <div className="space-y-2 p-4 bg-muted rounded-lg">
              <div className="flex justify-between text-sm">
                ...
                <span>{formatCurrency(availability.pricing.subtotal, 'USD')}</span>
              </div>
              {availability.pricing.insuranceFee > 0 && (
                <div className="flex justify-between text-sm">
                  <span>Insurance</span>
                  <span>{formatCurrency(availability.pricing.insuranceFee, 'USD')}</span>
                </div>
              )}
              <div className="flex justify-between text-sm">
              ...
              <div className="flex justify-between font-bold">
                <span>Total</span>
                <span>{formatCurrency(availability.pricing.totalPrice, 'USD')}</span>
              </div>
        ...
        {showBookingForm && (
          <Form {...form}>
            <form onSubmit={form.handleSubmit(handleBookNow, (errors) => console.log('Booking Errors:', errors))} className="space-y-4">
              <Separator />
