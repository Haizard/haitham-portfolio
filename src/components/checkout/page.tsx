        ...
        <div>
          <Card className="shadow-lg">
            <CardHeader>
              ...
              <CardDescription>
                Please provide your information to complete the purchase. This is a simulated checkout.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Form {...form}>
                <form onSubmit={form.handleSubmit(handlePlaceOrder)} className="space-y-6">
                  ...
                  />
                   <Button type="submit" className="w-full" size="lg" disabled={isProcessing}>
                    {isProcessing ? <Loader2 className="mr-2 h-5 w-5 animate-spin" /> : <ShoppingBag className="mr-2 h-5 w-5" />}
