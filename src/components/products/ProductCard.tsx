...
export const ProductCard: React.FC<ProductCardProps> = ({ product, onQuickView, className }) => {
  ...
  return (
    <Card 
        className={cn(
            "group relative flex w-full flex-col overflow-hidden rounded-lg border-gray-700 bg-gray-800 text-white shadow-lg transition-all duration-300 ease-in-out hover:border-primary/80 hover:shadow-2xl hover:-translate-y-2",
            className
        )}
    >
